  ...
  return (
    <BadgesWrapper>
      ...
      <div class="badge-grid">
        <div>
          <img src="https://raw.githubusercontent.com/layer5labs/meshery-extensions-packages/master/assets/badges/bring-a-buddy/bring-a-buddy.svg" alt="Layer5 badges" /><span>Bring a Buddy</span> <p>This badge is awarded to the users who invite someone to Layer5 cloud.</p>
        </div>
        <div>
